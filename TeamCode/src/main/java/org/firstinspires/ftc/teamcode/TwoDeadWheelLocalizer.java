...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3347.7442570416556; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1055.2665266894346; // x position of the perpendicular encoder (in tick units)
    }
